...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold" style="color: var(--text-primary);">
                <i class="fas fa-trash mr-2" style="color: var(--coral);"></i>Trash
            </h1>
            <p style="color: var(--text-secondary); font-size: 14px; margin-top: 4px;">Deleted categories - Restore or permanently delete</p>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div style="text-align: center; padding: 60px 20px;">
            ...
            <p style="color: var(--text-secondary); font-size: 13px; margin-top: 8px;">Deleted categories will appear here</p>
        </div>
        @endif
    </div>
...
function openDeleteModal(id, type, name) {
    ...
    if (type === 'category') {
        form.action = '/categories/' + id + '/force';
    }
